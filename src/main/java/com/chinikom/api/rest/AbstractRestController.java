...
import com.chinikom.domain.RestAPIExceptionInfo;
import com.chinikom.exception.HTTP400Exception;
import com.chinikom.exception.HTTP404Exception;
...
public abstract class AbstractRestController implements
	...
	RestAPIExceptionInfo handleDataStoreException(HTTP400Exception ex,
		...
		log.info("Converting Data Store exception to RestResponse : "
				+ ex.getMessage());
		counterService
				.increment("com.chinikom.AddressAndContactService.HTTP400.count");
		return new RestAPIExceptionInfo(ex,
				"The Request did not have correct parameters / body etc. Please check");
	}
	...
	RestAPIExceptionInfo handleResourceNotFoundException(HTTP404Exception ex,
		...
		counterService
				.increment("com.chinikom.AddressAndContactService.HTTP404.count");
